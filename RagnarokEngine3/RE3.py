...
class Ragnarok(object):
    ...
    def __init__(self, preferred_backbuffer_size=(-1, -1), window_name="Ragnarok Game", icon_path=None):
        global world
        """
        Prepares the Ragnarok library for use.
        preferred_back_size attempts to set the resolution of the window to the specified size. 
        (-1, -1) attempts native resolution.
...
class GUIMenu(DrawableObj):
    ...
    def update(self, milliseconds):
        ...
        # This is necessary to to get correct behavior when the menu first starts running.
    ...
    def warp_object(self, tileMapObj):
        ...
        if tileMapObj.can_warp:
            ...
            if self.map_association != self.exitWarp.map_association:
                ...
                TileMapManager.load(self.exitWarp.map_association)
...
class World(object):
    def __init__(self):
        ...
        self.__backbuffer = pygame.Surface((0, 0))
    ...
    def set_display_at_native_res(self, should_be_fullscreen=True):
        """Sets the resolution to the display's native resolution.
        Sets as fullscreen if should_be_fullscreen is true."""
    ...
    def remove_obj(self, obj):
        try:
            ...
            print("Ragnarok Says: Object with ID # " + str( obj.obj_id) +
                  " could not be found in the World collection. Skipping over...")
